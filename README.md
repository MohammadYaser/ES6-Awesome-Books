...
<br>
<br>
The Awesome Books project, created solely by me, showcases my skills and knowledge gained throughout my studies. This web-page demonstrates my critical thinking, problem-solving abilities, and research skills. It provides a book collection management system where users can add and remove books. The dynamically updated display allows users to visualize their collection effectively. By utilizing technologies like JavaScript ES6, HTML, CSS, and localStorage, I have created an intuitive and efficient user interface. The Awesome Books project reflects my commitment to continuous learning and my ability to develop practical web applications independently.
<br>
<br>
...
<br>
  ...
  <summary>Page was built using HTML, CSS, JavaScript and luxon library to display datetime<br>
...
- Choose a directory
- Open a Terminal
- write git clone https://github.com/MohammadYaser/ES6-Awesome-Books
...
Feel free to check the [issues page](https://github.com/MohammadYaser/ES6-Awesome-Books/issues).
...
<br>
<br>
[![Star](https://img.shields.io/github/stars/MohammadYaser/ES6-Awesome-Books?style=social)](https://github.com/MohammadYaser/ES6-Awesome-Books)
